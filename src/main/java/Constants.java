...
class Constants
{
    ...
    static String vocab_dir = root + "vocab/";
    static Long line_in_merged = 0L;
    static HashSet<String> stopWords;
    static Integer pages_per_file;
    static Integer filesToMergeAtATime;
    static Integer lines_per_splitFile;
    public static Long No_of_pages;
    ...
    Constants ()
    {
        ...
        pages_per_file = 100;    //10000  or 100
        filesToMergeAtATime = 5; //2000  or 5
        lines_per_splitFile = 10000;
    }
}
